<template>
  <div>
    ...
    <div class="container-fluid solution">
      <h3>解决方案</h3>
      <div class="row">
        <div class="col-md-5 solution-bg"></div>
        <div class="col-md-7 solution-txt">
          <p>{{content}}</p>
        </div>
      </div>
    </div>
    ...
    <div class="advantage">
      <h3>系统功能</h3>
      <img src="../../static/bil/imgamge/20180629105526.png" alt="">
    </div>
    <bottom></bottom>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        content: ' 运用云计算、大数据、移动互联等新一代信息技术，采用SOA的服务架构体系，基于物联网的数据智能采集，在实验大数据深度' +
...
<style scoped>
  .system_banner {
    ...
    width: 100%;
    height: 5rem;
    background: url("../../static/bil/imgamge/20180628155836.jpg") no-repeat;
