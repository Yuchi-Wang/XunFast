<template>
  <div>
    ...
    <div class="advantage">
      <h3>系统优势</h3>
      <img src="../../static/bil/imgamge/20180705091136.png" alt="">
    </div>
    ...
    <div class="advantage">
      <h3>系统功能</h3>
      <img src="../../static/bil/imgamge/20180705094732.png" alt="">
    </div>
    <bottom></bottom>
  </div>
</template>
...
<style scoped>
  .system_banner {
    ...
    width: 100%;
    height: 5rem;
    background: url("../../static/bil/imgamge/20180702171902.jpg") no-repeat;
