            ...
            <div class="container-fluid select">
                <div class="row">
                    <ul class="service_title row" id="service_title">
                        <li class="col-3" v-for="(item,index) in lists" :key="item.index" @click="tabs(index)" v-bind:style="{background:index===checkIndex?'#008fd7':'',color:index===checkIndex?'white':''}">{{ item }}
                        </li>
                    </ul>
                    <ul id="service_content" class="row col-12 clearfix">
                        <li v-for="(item,index) in imgArray" :key="item.index" v-show="index===checkIndex" class="col-sm-12">
                            ...
                            <ol v-show="index===3" style="margin-bottom: 60px">
                                ...
                                <li class="count">招聘人数:
                                    <span v-for="(item,index) in listdata" :key="item.index" v-show="index===tabsIndex">{{item.Count}}</span>人</li>
...
.service_title > li:nth-of-type(1),
.service_title > li:nth-of-type(2),
.service_title > li:nth-of-type(3) {
